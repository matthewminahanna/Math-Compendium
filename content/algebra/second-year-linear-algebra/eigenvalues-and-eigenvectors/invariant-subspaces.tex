...
\begin{dfn}
    Suppose \( T \in \mathcal{L} \left(  \mathbf{V} \right) \). We say that \( \vb{v} \in \mathbf{V} \) is an \vocab{eigenvector} of \( T \) if there exists a \( \lambda \in \mathbb{K} \), called the \vocab{eigenvalue}, such that \( T \vb{v} = \lambda \vb{v} \).
\end{dfn}