...
\end{lemma}
\begin{proof}
    We just need to check that \( \left( \vb{x} \times  \vb{y} \right) \cdot \vb{x} \) and \( \left( \vb{x} \times  \vb{y} \right) \cdot \vb{y} \) are both \( 0 \).
    \begin{align*}
        \left( \vb{x} \times  \vb{y} \right) \cdot \vb{x} &= \left< x_{2}y_{3} - x_{3}y_{2} , \;  x_{3}y_{1}-x_{1}y_{3}, \; x_{1}y_{2}- x_{2}y_{1}  \right> \cdot \left< x_{1}, x_{2}, x_{3} \right> \\
        &= x_{1} \left( x_{2}y_{3} - x_{3}y_{2} \right) + x_{2} \left(   x_{3}y_{1}-x_{1}y_{3} \right) + x_{3} \left(  x_{1}y_{2}- x_{2}y_{1}  \right) \\
        &= x_{1}x_{2}y_{3}-x_{1}x_{3}y_{2} + x_{2}x_{3}y_{1} - x_{2}x_{1}y_{3}+ x_{3}x_{1}y_{2}- x_{3} x_{2}y_{1} \\
        &= \Ccancel[DeepRed]{x_{1}x_{2}y_{3}} - \Ccancel[AmberOrange]{x_{1}x_{3}y_{2}}   + \Ccancel[GoldenYellow]{ x_{2}x_{3}y_{1}}  - \Ccancel[DeepRed]{x_{2}x_{1}y_{3}} + \Ccancel[AmberOrange]{x_{3}x_{1}y_{2}} - \Ccancel[GoldenYellow]{ x_{3} x_{2}y_{1}}\\
        &=0
    \end{align*}
    
     \begin{align*}
        \left( \vb{x} \times  \vb{y} \right) \cdot \vb{y} &= \left< x_{2}y_{3} - x_{3}y_{2} , \;  x_{3}y_{1}-x_{1}y_{3}, \; x_{1}y_{2}- x_{2}y_{1}  \right> \cdot \left< y_{1}, y_{2}, y_{3} \right> \\
        &= y_{1} \left( x_{2}y_{3} - x_{3}y_{2} \right) + y_{2} \left(   x_{3}y_{1}-x_{1}y_{3} \right) + y_{3} \left(  x_{1}y_{2}- x_{2}y_{1}  \right) \\
        &= y_{1}x_{2}y_{3}-y_{1}x_{3}y_{2} + y_{2}x_{3}y_{1} - y_{2}x_{1}y_{3}+ y_{3}x_{1}y_{2}- y_{3} x_{2}y_{1} \\
        &= \Ccancel[DeepRed]{y_{1}x_{2}y_{3}} - \Ccancel[GoldenYellow]{y_{1}x_{3}y_{2}}   + \Ccancel[GoldenYellow]{ y_{2}x_{3}y_{1}}  - \Ccancel[AmberOrange]{y_{2}x_{1}y_{3}} + \Ccancel[AmberOrange]{y_{3}x_{1}y_{2}} - \Ccancel[DeepRed]{ y_{3} x_{2}y_{1}} \\ 
        &=0
    \end{align*}
\end{proof}
\begin{exercise}
