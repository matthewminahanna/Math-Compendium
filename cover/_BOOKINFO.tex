\newcommand{\bookauthor}{Matthew-Mina Hanna}
\newcommand{\shortbookauthor}{Hanna}
\newcommand{\booktitle}{Math Compendium}
\newcommand{\booksubtitle}{This resource and its source code are free to use.}
