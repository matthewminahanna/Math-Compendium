% Begin initial call of packages
\usepackage{makeidx}
\makeindex
...
\declaretheorem[style=theoremst, name=Corollary, sibling=theorem]{corollary}
...
\declaretheoremstyle[
    ...
    mdframed={
        ...
        skipabove = 0pt,
        rightline=false, topline=false, bottomline=false,
        linecolor=theoremcolor, backgroundcolor=theoremcolor!5,
    },
    qed = $\blacksquare$
]{proofalt}
\declaretheorem[style=proofalt, name=Alternative Proof]{altproof}
...
\definecolor{ctp-base}{HTML}{1e1e2e}      % Dark background
\definecolor{ctp-green}{HTML}{a6e3a1}     % Green (primary - matrix vibe)
\definecolor{ctp-teal}{HTML}{94e2d5}      % Teal (secondary accent)
\definecolor{ctp-surface}{HTML}{9ca0b0}   % Subtle gray for comments
\definecolor{ctp-text}{HTML}{cdd6f4}      % White for line numbers

% Base Catppuccin style with matrix green theme
\lstdefinestyle{catppuccin-base}{
    numbers=left,
    numberstyle=\color{ctp-text},
    numbersep=8pt,
    backgroundcolor=\color{ctp-base},
    basicstyle=\ttfamily\color{ctp-green},
    keywordstyle=\color{ctp-green}\bfseries,
    commentstyle=\color{ctp-surface}\itshape,
    stringstyle=\color{ctp-teal},
    identifierstyle=\color{ctp-green},
    breaklines=true,
    columns=flexible,
    keepspaces=true,
...
\lstdefinestyle{catppuccin-python}{
    ...
    language=Python,
    morekeywords={self, True, False, None, lambda, yield, async, await},
    sensitive=true,
}

% R style
\lstdefinestyle{catppuccin-r}{
    style=catppuccin-base,
    language=R,
    morekeywords={tibble, mutate, filter, select, ggplot, aes, geom_point},
    alsoletter={., _},
}

% Octave/MATLAB style
\lstdefinestyle{catppuccin-octave}{
    style=catppuccin-base,
    language=Octave,
    morekeywords={endfunction, endfor, endwhile, endif},
}

% SageMath style (Python-based)
\lstdefinestyle{catppuccin-sage}{
    style=catppuccin-python,
    morekeywords={QQ, ZZ, RR, CC, GF, Matrix, vector, var, solve, factor, expand},
}
...
\declaretheoremstyle[
    spaceabove = 1pt,
    headindent = 1pt,
    headfont=\bfseries\sffamily\color{ctp-green},
    bodyfont=\normalfont\color{ctp-green},
    postheadspace=\newline,
    postheadhook=\noindent,
    mdframed={
        linewidth=3pt,
...
\declaretheorem[style=codingexamplest, name= \hspace{-20pt} Coding Example, numbered=no]{codingexample}
...
\renewcommand*{\l@part}[2]{%
  \ifnum \scr@tocdepth >-2\relax
    ...
    \begingroup
      ...
      \hskip -\leftskip
      \llap{\thepart\enskip \quad}% â† ADD SPACE HERE
