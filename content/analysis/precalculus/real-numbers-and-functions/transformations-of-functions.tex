...
\begin{exercise}
  Suppose that \( f(x)=2x^{2}-3 \) and \( g(x) = 3x+1 \). 
  \begin{enumerate}[label=\textbf{\roman*)}]
    \item Find \( \left( f \circ g \right)(x) \)
    \item Find \( \left( g \circ f \right)(x) \)
    \item For what values of \( x \) will \(   \left( f \circ g \right)(x) = \left( g \circ f \right)(x)\)?
  \end{enumerate}
\end{exercise}
\begin{solution}
    $ $\vspace{-1.5em}
    \begin{enumerate}[label=\textbf{\roman*)}]
      ...
      \begin{align*}
        ...
        &= f \left( 3x+1 \right) \\
        &= 2 \left( 3x+1 \right)^{2} -3 \\
        &= 2 \left( 9x^{2} +6x+1 \right)-3 \\
        &= 18x^{2}+12x -1
      \end{align*}
      \item Similarly 
      \begin{align*}
        ...
        &= 6x^{2}-8
      \end{align*}
      \item We have \( 18x^{2}+12x-1=6x^{2}-8 \) or that \( 12x^{2} + 12x +7=0 \). Apply the quadratic formula. 
      \begin{align*}
        &\frac{-12 \pm \sqrt{12^{2} - 4(12)(7)}}{24} \\
        & \frac{-12 \pm \sqrt{12 \left( 12 - 4 \cdot 7 \right)}}{24} \\
        & \frac{-12 \pm \sqrt{12 \cdot 4 \cdot \left( 3-7 \right)}}{24}\\
        & \frac{-12 \pm \sqrt{12 \cdot 4 \cdot \left(-4\right)}}{24} \\
        &  \frac{-12 \pm \sqrt{-3 \cdot 2^{2} \cdot 2^{2} \cdot 2^{2}}}{24} \\
        & \frac{-12 \pm 8 \sqrt{3}i}{24} \\
        & - \frac{1}{2} \pm \frac{\sqrt{3}}{3}
      \end{align*}
      Now let us check that these are indeed the roots of \( 12x^{2} + 12x +7 \)
      \begin{align*}
        x &=  -\frac{1}{2} \pm \frac{\sqrt{3}}{3} i \\
        6x &= -3 \pm 2 \sqrt{3} i\\
        6x+3 &= \pm 2\sqrt{3}i \\
        \left( 3 \cdot \left( 2x +1 \right) \right)^{2} &= \left( 2\sqrt{3}i \right)^{2} \\
        9 \left( 4x^{2} + 4x +1\right) &= -12 \\
        3 \left( 4x^{2} + 4x +1\right) &= -4\\
        12 x^{2} + 12x + 7 &= 0
      \end{align*}
