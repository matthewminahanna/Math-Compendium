...
\parttoc
\input{content/analysis/precalculus/precalculus-master}
...
\parttoc 
\input{content/analysis/fourier-analysis/fourier-analysis-master}
...
\label{Algebras}
\parttoc
\input{content/algebra/algebras/algebras-master}
...
\part{Gauge Theory}
\vspace*{2em} The primary resource for this part is \cite{ref:hamilton_gauge}.  My personal understanding has greatly benefited from use of \cite{ref:baez_knots} and \cite{ref:garrity_em}.\vspace*{-1em}
